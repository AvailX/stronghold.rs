...
pub use primitives::{
    ...
    BIP39Generate, BIP39Recover, ConcatKdf, ConcatSecret, CopyRecord, Curve, Ed25519Sign, GarbageCollect, GenerateKey,
    GetAleoAddress, GetAleoViewKey, GetEvmAddress, Hkdf, Hmac, KeyType, MnemonicLanguage, Pbkdf2Hmac, PublicKey,
    RevokeData, Secp256k1EcdsaFlavor, Secp256k1EcdsaSign, Sha2Hash, Slip10Chain, Slip10ChainCode, Slip10Derive,
